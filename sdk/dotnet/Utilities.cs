...
namespace Pulumi.Gomigrate
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Gomigrate.version.txt");
    ...
    internal sealed class GomigrateResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public GomigrateResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
